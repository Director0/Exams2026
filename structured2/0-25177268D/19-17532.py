...
print(19, [s for s in range(1, 59) if any(play(t) in "V1" for t in moves((6, s)))])
print(19, [s for s in range(1, 59) if play((6, s)) in "V2"])
print(19, [s for s in range(1, 59) if play((6, s)) in "P2"])