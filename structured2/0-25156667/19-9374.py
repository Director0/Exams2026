...
print(19, [s for s in range(1, 40 + 1) if any(play(t) in "V1" for t in moves((3, s)))])
print(19, [s for s in range(1, 40 + 1) if play((3, s)) in "V2"])
print(19, [s for s in range(1, 40 + 1) if play((3, s)) in "P2"])